...
import com.example.climaapp.tutorialteste.Event
import com.example.climaapp.R
import com.example.climaapp.tutorialteste.Result
import com.example.climaapp.tutorialteste.Result.Success
import com.example.climaapp.tutorialteste.Task
import com.example.climaapp.tutorialteste.DefaultTasksRepository
import com.example.climaapp.tutorialteste.TasksDataSource
        ...
        when (requestType) {
            TasksFilterType.ALL_TASKS -> {
                setFilter(
                    ...
                    R.drawable.ic_baseline_close_24, true
                )
            }
            TasksFilterType.ACTIVE_TASKS -> {
                setFilter(
                    R.string.label_active, R.string.no_tasks_active,
                    R.drawable.ic_baseline_close_24, false
                )
            }
